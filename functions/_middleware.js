export async function onRequest(context){
  ...
  if(!injected.includes('/art-loader.js')){
    injected=injected.replace('</body>','<script src="/art-loader.js?v=20260919-2" defer></script></body>');
  }
  if(!injected.includes('/book-links.js')){
    injected=injected.replace('</body>','<script src="/book-links.js?v=20260919-3" defer></script></body>');
  }
